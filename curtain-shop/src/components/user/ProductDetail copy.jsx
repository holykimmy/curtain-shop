...
function ContactPage() {
  ...
  return (
    <>
            ...
            <div className="flex justify-between w-[90%] h-auto shadow-md border rounded mt-2 mb-4 p-3">
              ...
              <div className="pl-10 pr-10 pt-5 ">
                ...
                <div className="text-md mt-4 text-brown-400 whitespace-pre-wrap">
                  <span className>รายละเอียดสินค้า : </span>  ผ้าม่าน PRO TEXTILE  ผ้าสีทองอ่อน เป็นผ้าผิวมันสะท้อนเเสง ตัวผ้ามีการพิมพ์ลาดลายดอกบัวบานผสานกับดอกบัวตูม ลวดลายมีความเด่นชัด เท็กซ์เจอร์ในการสัมผัสและเนื้อผ้าดี ป้องกันแสงได้ถึง 95% ทำให้ช่วยในการพักผ่อนและให้ความเป็นส่วนตัว  \r\nประเภทผ้า : ผ้าทำจาก Polyester 100 % มีความเหนียว คงทน และแข็งแรง คงสภาพและคงรูปร่างได้ดี และไม่ยับง่าย ความสามารถในการดูดความชื้นต่ำ \r\nการทำความสะอาด : สามารถซักน้ำและซักแห้งได้ แต่ซักอย่างอ่อนโยน และไม่ควรใช้สารฟอกขาว \r\n\r\n\r\nข้อแนะนำ : การรีดเนื้อผ้าควรใช้ไฟอ่อนถึงปานกลาง {product.detail}
                </div>
      ...
      <div className="font-semibold text-brown-600 text-base md:text-lg lg:text-lg ml-10 my-5 "> สินค้าแนะนำเพิ่มเติมเกี่ยวกับสินค้าในหมวด  </div>
